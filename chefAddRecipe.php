    ...
    if (!move_uploaded_file($tempname, $folder)) {
        ...
        try {
            $insert_recipe = "INSERT INTO recipe (
                title, cooking_time, serving, difficulty_lvl, image, created_at, 
                video, details, expiry_date, chefs_id, cuisine_typeID, meal_typesID
            ) VALUES (
                '$title', $cooking_time, $serving, '$difficulty', '$filename', '$created_at', 
            ...
            foreach ($_POST['instructions'] as $index => $step) {
                if (!empty(trim($step))) {
                    ...
                    $insert_instruction = "INSERT INTO instructions (cooking_step, step_nbr, recipe_id) 
  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="chefAddRecipe.php"><i class="fas fa-plus-circle"></i> Add Recipe</a>
                    </li>
    ...
    <div class="hero">
        <div class="container">
            ...
            <h1><i class="fas fa-plus-circle me-2"></i>Add New Recipe</h1>
            <p class="mb-0">Share your culinary masterpiece with the world</p>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="chefAddRecipe.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="e.g. Creamy Garlic Pasta" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="serving" name="serving" min="1" required>
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="goal" name="goal">
                                        ...
                                        <?php foreach ($goals as $goal): ?>
                                            <option value="<?php echo $goal['GoalID']; ?>"><?php echo htmlspecialchars($goal['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="cuisine_type" name="cuisine_type" required>
                                        ...
                                        <?php foreach ($cuisine_types as $cuisine): ?>
                                            <option value="<?php echo $cuisine['CuisineID']; ?>"><?php echo htmlspecialchars($cuisine['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="meal_type" name="meal_type" required>
                                        ...
                                        <?php foreach ($meal_types as $meal): ?>
                                            <option value="<?php echo $meal['MealID']; ?>"><?php echo htmlspecialchars($meal['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="ingredients-container">
                                <div class="ingredient-row">
                                    <div class="ingredient-number fw-bold">1.</div>
                                    ...
                                    <div class="ingredient-input" style="max-width: 100px;">
                                        <input type="number" step="0.01" class="form-control" name="ingredient_quantity[]" placeholder="Qty" required>
                                    </div>
                                ...
                                <div class="ingredient-row">
                                    <div class="ingredient-number fw-bold">2.</div>
                                    <div class="ingredient-input">
                                        <input type="text" class="form-control" name="ingredient_name[]" placeholder="Ingredient name" required>
                                    </div>
                                    <div class="ingredient-input" style="max-width: 100px;">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="imagePreview" src="#" alt="Recipe Image Preview" class="mt-2">
                            </div>
                            ...
                            <div id="instructions">
                                <div class="instruction-container mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <textarea class="form-control" name="instructions[]" rows="3" placeholder="Enter step 1" required></textarea>
                                        </div>
                                    </div>
                                    <label class="form-label">Step Image (Optional)</label>
                                    <div class="instruction-image-container" onclick="document.getElementById('instruction-image-1').click()">
                                        <i class="fas fa-camera"></i>
                                        <img id="instruction-image-preview-1" class="ingredient-image-preview">
                                        <input type="file" id="instruction-image-1" name="instruction_image[]" accept="image/*" style="display: none;" onchange="previewInstructionImage(event, 1)">
                                    </div>
                                </div>
                                ...
                                <div class="instruction-container mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <textarea class="form-control" name="instructions[]" rows="3" placeholder="Enter step 2" required></textarea>
                                        </div>
                                    </div>
                                    <label class="form-label">Step Image (Optional)</label>
                                    <div class="instruction-image-container" onclick="document.getElementById('instruction-image-2').click()">
                                        <i class="fas fa-camera"></i>
                                        <img id="instruction-image-preview-2" class="ingredient-image-preview">
                                        <input type="file" id="instruction-image-2" name="instruction_image[]" accept="image/*" style="display: none;" onchange="previewInstructionImage(event, 2)">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" id="video" name="video" placeholder="https://youtube.com/watch?v=...">
                            </div>
                            
                            <div class="mb-3">
                                <label for="details" class="form-label">Recipe Details (Optional)</label>
                                <textarea class="form-control" id="details" name="details" rows="3" placeholder="Any additional information about your recipe..."></textarea>
                            </div>
                            
                            <div class="mb-4">
                                <label for="expiry_date" class="form-label" required>Period of validity (in days)</label>
    ...
    <script>
        ...
        // Function to add more instructions dynamically
